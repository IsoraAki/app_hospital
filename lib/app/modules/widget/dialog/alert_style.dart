...
const EdgeInsets defaultAlertPadding = EdgeInsets.symmetric(horizontal: 16.0, vertical: 24.0);
...
class AlertStyle {
  ...
  const AlertStyle({
    ...
    this.titleStyle = const TextStyle(color: Colors.white, fontWeight: FontWeight.w500, fontSize: 18, fontStyle: FontStyle.normal, fontFamily: AppFonts.baiJamjuree),
